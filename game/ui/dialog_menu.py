"""
CinePlex Dreams — Dialog Menus
Interactive popups for Ticket Booth, Concession Stand, and Usher Checkpoint.
"""
import pygame
import math
...
class DialogMenu:
    """Base class for an interactive popup menu."""
    ...
    def draw(self, surface: pygame.Surface):
        ...
        # Blit panel centered with animation scale
...
class UsherDialog:
    ...
    def handle_event(self, event):
        return self.active # Block input while scanning
